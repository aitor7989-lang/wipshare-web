...
const downloadPill =
  'inline-flex h-8 items-center gap-2 rounded-full border border-transparent bg-[#e9eaed] px-4 text-[13px] font-medium text-[#0b0c0d] shadow-[inset_0_1px_0_rgba(255,255,255,0.85),0_1px_2px_rgba(0,0,0,0.4)] transition-colors hover:bg-white';
